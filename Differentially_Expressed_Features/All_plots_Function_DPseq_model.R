...
create_and_save_barplot <- function(plot_data, file_suffix , Title) {
  ...
  # Save PDF
  pdf(here::here("graphs", "DPseq_model", paste0(file_suffix, ".pdf")), width = 9, height = 6)
  print(p)
  dev.off()
  
  # Save JPEG
  jpeg(here::here("graphs", "DPseq_model", paste0(file_suffix, ".jpg")), width = 6000, height = 4000, res = 600)
  print(p)
  dev.off()
}

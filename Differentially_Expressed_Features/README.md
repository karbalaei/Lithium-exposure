...
Following the retrieval of preprocessed count data, lowly expressed features were filtered out to improve statistical power. A design matrix was then constructed using the `model.matrix()` function, incorporating quality surrogate variables [(qSVs)](https://www.pnas.org/doi/abs/10.1073/pnas.1617384114) derived from [previous benchmarks](https://pubmed.ncbi.nlm.nih.gov/35260864/) to rigorously control for unobserved technical covariates and batch effects.

...
write.csv(geneOut ,  here("results" , "Lithium_DPseq_model_gene.csv"))
...
write.csv(exonOut , here("results", "Lithium_DPseq_model_exon.csv"))
...
write.csv(jxnOut , here("results", "Lithium_DPseq_model_Jxn.csv"))
...
write.csv(txOut , here("results", "Lithium_DPseq_model_Transcript.csv"))
...
Lithium_DPseqmodel <-  list("gene" = geneOut_list, "exon" = exonOut_list, "jxn" = jxnOut_list ,"tx" = txOut_list)


save(Lithium_DPseqmodel , file = here("results", "Lithium results DPseqmodel.RDS"))

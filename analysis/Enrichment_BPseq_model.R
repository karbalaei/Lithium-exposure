...
## Define Universe
all_gencode <- map_depth(Lithium_BPseqmodel, 2, "common_gene_id")
...
#### Get signif genes####
signif_genes_whole_list<- map_depth(Lithium_BPseqmodel, 2, ~get_signif(.x, colname = "common_gene_id", return_unique = TRUE , UpDown = "none" ))
...
signif_genes_up <- map_depth(Lithium_BPseqmodel, 2, ~get_signif(.x, colname = "common_gene_id", return_unique = TRUE , UpDown = "Up" ))

signif_genes_down<- map_depth(Lithium_BPseqmodel, 2, ~get_signif(.x, colname = "common_gene_id", return_unique = TRUE , UpDown = "Down" ))
...
walk2(names(all_plots), all_plots, ~ggsave(filename = here("graphs" , "BPseq_model" ,  "Enrichment results" , "whole_list" , paste0(.x , ".jpg")), plot = .y, 
                                             height = 14, width = 9))



pdf(here("graphs" , "BPseq_model" ,  "Enrichment results" , "whole_list" ,  "Enrichment results Lithium exposure.pdf") , height = 14 , width = 9)
...
walk2(names(all_plots_up), all_plots_up, ~ggsave(filename = here("graphs" , "BPseq_model" ,  "Enrichment results" , "up" , paste0(.x , ".jpg")), plot = .y, 
                                             height = 14, width = 9))




pdf(here("graphs" , "BPseq_model" ,  "Enrichment results" , "up" , "Enrichment results Lithium exposure_up.pdf") , height = 14 , width = 9)
...
walk2(names(all_plots_down), all_plots_down, ~ggsave(filename = here("graphs" , "BPseq_model" , "Enrichment results" , "down" , paste0(.x , ".jpg")), plot = .y, 
                                             height = 14, width = 9))


pdf(here("graphs" , "BPseq_model" , "Enrichment results" , "down"  , "Enrichment results Lithium exposure_down.pdf") , height = 14 , width = 9)

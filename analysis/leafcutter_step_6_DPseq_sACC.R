...
load(here("leafcutter/data/covariates_results/step_5_DPseq_sACC.Rdata"))
...
walk( clusters$clusterID , ~make_cluster_plot(cluster_to_plot = .x ,exons_table = exons_table ,cluster_ids = cluster_ids , introns =  introns , meta = meta , counts = counts ,snp_pos <-  NA , file_path = here("graphs" , "DPseq_model" , "leafcutter" , region= "sACC" ,  paste0(.x , "_graph.pdf"))))
